...
def save_data_at_frame(mpm_solver, mpm_state, dir_name, frame, save_to_ply=True, save_to_h5=False):
    os.umask(0)
    ...
    if save_to_ply:
        particle_position_to_ply(mpm_solver, mpm_state, fullfilename[:-2] + "ply")
    ...
    if save_to_h5:
        ...
        x_np = (
            mpm_state.particle_x.numpy().transpose()
